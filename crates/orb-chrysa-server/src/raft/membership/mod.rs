...
mod tests {
    ...
    fn restored_peer_targets_exclude_self_and_deduplicate() {
        let peers = restored_membership_peer_targets(
            vec![
                (
                    1,
                    "orb-chrysa-0.orb-chrysa-headless.ns.svc.cluster.local:5051".to_string(),
                ),
                (
                    2,
                    "orb-chrysa-1.orb-chrysa-headless.ns.svc.cluster.local:5051".to_string(),
                ),
                (
                    3,
                    "orb-chrysa-2.orb-chrysa-headless.ns.svc.cluster.local:5051".to_string(),
                ),
                (
                    4,
                    "orb-chrysa-2.orb-chrysa-headless.ns.svc.cluster.local:5051".to_string(),
    ...
    fn verification_targets_prefer_restored_membership_peers() {
        ...
        let discovered = vec!["orb-chrysa-headless:5051".to_string()];
    ...
    fn join_peer_targets_try_restored_peers_before_discovery() {
        assert_eq!(
            merge_seed_and_discovered_peers(
                ...
                vec![
                    "orb-chrysa-1.orb-chrysa-headless.ns.svc.cluster.local:5051".to_string(),
                    "orb-chrysa-headless:5051".to_string(),
                ],
            ),
            vec![
                "orb-chrysa-0.orb-chrysa-headless.ns.svc.cluster.local:5051".to_string(),
    ...
    fn fresh_join_derives_ordinal_zero_seed_from_advertise_addr() {
        assert_eq!(
            ordinal_zero_peer_target("orb-chrysa-2.orb-chrysa-headless.ns.svc.cluster.local:5051"),
            Some("orb-chrysa-0.orb-chrysa-headless.ns.svc.cluster.local:5051".to_string())
        );
    }

    #[test]
    fn fresh_join_seed_ignores_unparseable_advertise_addr() {
        assert_eq!(ordinal_zero_peer_target("orb-chrysa-headless:5051"), None);
        assert_eq!(
            ordinal_zero_peer_target("orb-chrysa-a.orb-chrysa-headless:5051"),
            None
        );
    }
}
